...
const Setting = ({marginTopRight, item}: SettingPropsType) => {
const [open,setOpen] = useState(false)
    ...
    return (
        <div className={`margin-top-right_${marginTopRight}`}>
            ...
            <svg width="4" height="16" viewBox="0 0 4 16" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={setOpenHandler}>
